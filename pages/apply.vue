<template>
  <div class="p-3 lg:p-4">
    <div class="bg-white rounded-md border border-gray-200 mx-auto max-w-screen-sm overflow-hidden divide-y divide-gray-200 shadow-sm">
      ...
      <div class="p-3 lg:p-4 space-y-3 lg:space-y-4">
        <div class="relative">
          ...
          >
            <img
                ...
                alt="Company logo"
                class="aspect-1/1 object-cover rounded-md h-20 absolute left-3 bottom-3"
            >
          </a>
        ...
        <dl class="grid grid-cols-1 md:grid-cols-2 p-2 gap-2 bg-gray-50 rounded-md border border-gray-200">
          ...
          <div v-if="tokenInfo.position.salary" class="col-span-1 text-sm space-y-1 bg-white rounded-md p-2 border border-gray-200">
