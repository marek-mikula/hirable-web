  ...
  <div class="min-h-screen max-w-screen-2xl mx-auto flex items-start">
                ...
                <div class="h-full bg-white divide-y divide-gray-200">
                  ...
                  <div class="p-4">
                    <div class="rounded-md flex items-center space-x-2">
                      ...
                      <span class="font-medium">Hirable</span>
                    </div>
                  </div>
                  ...
                  <div class="p-4">
                    <nav class="flex flex-1 flex-col">
                      <ul role="list" class="flex flex-1 flex-col gap-y-3">
                        <li class="space-y-2">
                          <div class="text-xs/6 text-gray-500 font-medium">Hlavní menu</div>
                        ...
                        <li class="space-y-2">
                          <div class="text-xs/6 text-gray-500 font-medium">Nastavení</div>
                          <ul role="list" class="space-y-1">
    ...
    <div class="hidden lg:block w-72 shrink-0 h-screen sticky top-0">
      <div class="p-3 lg:p-4 h-full flex flex-col">
        ...
        <!-- footer section -->
        <div class="shrink-0 mt-4 text-xs text-gray-500 space-x-1 leading-6">
          <NuxtLink to="/terms-and-conditions" class="hover:underline">Smluvní podmínky</NuxtLink>
          <span>•</span>
          <NuxtLink to="/gdpr" class="hover:underline">GDPR</NuxtLink>
          <span>•</span>
          <NuxtLink to="/cookies" class="hover:underline">Cookies</NuxtLink>
          <span>•</span>
          <span>
            Made with ❤️, <a href="https://www.linkedin.com/in/marek-mikula/" target="_blank" class="hover:underline">Marek Mikula</a> © 2025
          </span>
        </div>
      </div>
    </div>
      ...
      <div class="min-w-0 grid h-full lg:py-4 lg:pr-4">
        <main class="min-w-0 h-full">
          <div class="h-full bg-white p-3 lg:p-4 lg:rounded-md lg:border lg:border-gray-200">
            ...
            <LayoutBreadcrumbs class="mb-3 lg:mb-4"/>
