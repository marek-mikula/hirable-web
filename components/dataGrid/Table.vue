      ...
      <div class="border border-gray-300 rounded-md overflow-hidden">
                ...
                <div class="flex items-center space-x-2">
                  ...
                  <template v-if="column.allowSort">
                    ...
                    <template v-if="_.get(query.sort, column.key) === undefined">
                      <CommonButton color="secondary" :disabled="dataLoading" :size="2" symmetrical v-tooltip="{ placement: 'top', content: $t('common.table.sort.asc') }" @click="onSort(column)">
                    ...
                    <template v-else-if="_.get(query.sort, column.key) === ORDER.ASC">
                      <CommonButton color="primary" :disabled="dataLoading" :size="2" symmetrical v-tooltip="{ placement: 'top', content: $t('common.table.sort.desc') }" @click="onSort(column)">
                    ...
                    <template v-else>
                      <CommonButton color="primary" :disabled="dataLoading" :size="2" symmetrical v-tooltip="{ placement: 'top', content: $t('common.table.sort.default') }" @click="onSort(column)">
        ...
        <div class="p-4 py-3 border-t border-gray-300 flex items-center justify-between space-x-2">
          ...
          <div class="flex items-center space-x-2 truncate">
            <CommonButton v-if="grid.allowSettings" color="secondary" :disabled="dataLoading" symmetrical @click="settingsModalOpened = true">
