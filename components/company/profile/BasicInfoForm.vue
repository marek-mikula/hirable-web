<template>
  <CommonForm id="company-form" v-slot="{ isLoading, firstError }" class="divide-y divide-gray-200 border border-gray-200 rounded-lg bg-white shadow-xs" :handler="handler">
