<template>
  <CommonForm id="password-form" v-slot="{ isLoading, firstError }" class="divide-y divide-gray-200 border border-gray-200 overflow-hidden rounded-lg bg-white shadow-xs" :handler="handler">
    <div class="px-4 py-3">
